...
import type { PersonRelation } from '@/lib/data-loaders/common'
import type { PersonDetailData } from '@/lib/data-loaders/person-detail'
...
export function PersonDetailClient({ id, data }: { id: string; data: PersonDetailData }) {
  const { person, persons, relations, mentions, personRelations } = data
