...
import type { TagDetailData } from '@/lib/data-loaders/tag-detail'
...
export function TagDetailClient({ data }: { data: TagDetailData }) {
  const { tag, parentTag, childTags, tagContent, trendData, relatedChannels, relatedPersons } = data
